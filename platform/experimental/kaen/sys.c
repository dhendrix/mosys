...
static const char *kaen_tegra2_get_name(struct platform_intf *intf)
{
	char *ret = NULL;
...
#if 0
static const char *kaen_tegra2_get_family(struct platform_intf *intf)
{
	/* FIXME: add then when it becomes public */
}
#endif
...
//	.family		= &kaen_tegra2_get_family,
	.version	= &kaen_tegra2_get_version,
};
